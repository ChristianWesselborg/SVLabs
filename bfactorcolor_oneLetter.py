...
#cmd.load("c:/users/wessec/documents/research/rpi gb/Zdockoutput/blocked_6ira/Docking_3SQ9/dim_lateralA2T/receptor_block.pdb")
cmd.alter("all", "b=0.0")

file = open("c:/users/wessec/documents/research/rpi gb/data/bfactor/3sq9_blocked/zdock/mono_receptorAV.csv", 'r')
...
cmd.show("surface", "interface")
cmd.set("transparency", "0.2")
#cmd.color("grey", "not interface")

cmd.spectrum("b", "salmon_red", "interface", minimum = 0, maximum = max)
