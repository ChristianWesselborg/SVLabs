...
path <- "C:/Users/WESSEC/Documents/Research/RPI GB/Zdockoutput/blocked_3SQ9/Docking_3SQ9/dim_lateralA2T/Analysis/20210813_164507_output.txt"
...
naoreslist <- read.csv("c:/users/wessec/documents/research/rpi gb/misc/pdb extract/dim_lateralA2T_reslist.txt", skip = 0, header = F, sep = "", stringsAsFactors = F)
colnames(naoreslist) <- "2nao_reslist"
irareslist <- read.csv("c:/users/wessec/documents/research/rpi gb/misc/pdb extract/3SQ9_reslist.txt", skip = 0, header = F, sep = "", stringsAsFactors = F)
colnames(irareslist) <- "3SQ9_reslist"

dim_lateralreceptorAT <- data.frame(matrix(nrow = 0, ncol = 2))
colnames(dim_lateralreceptorAT) <- c("3SQ9_reslist", "receptor_freq")
dim_lateralligandAT <- data.frame(matrix(nrow = 0, ncol = 2))
colnames(dim_lateralligandAT) <- c("2nao_reslist", "ligand_freq")
...
dim_lateralreceptorAT$receptor_freq <- 0
for (i in rlist){
  dim_lateralreceptorAT[dim_lateralreceptorAT$`3SQ9_reslist` == i, ]$receptor_freq <- dim_lateralreceptorAT[dim_lateralreceptorAT$`3SQ9_reslist` == i, ]$receptor_freq + 1
}
...
write.csv(dim_lateralligandAT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_lateralligandAT.csv")

write.csv(dim_lateralreceptorAT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_lateralreceptorAT.csv")

#A2V
rm(list = ls())

path <- "c:/users/wessec/documents/research/rpi gb/zdockoutput/blocked_3SQ9/Docking_3SQ9/dim_lateralA2V/Analysis/20210813_174650_output.txt"
...
dim_lateralreceptorAV <- data.frame(matrix(nrow = 0, ncol = 2))
colnames(dim_lateralreceptorAV) <- c("3SQ9_reslist", "receptor_freq")
dim_lateralligandAV <- data.frame(matrix(nrow = 0, ncol = 2))
colnames(dim_lateralligandAV) <- c("2nao_reslist", "ligand_freq")
...
dim_lateralreceptorAV$receptor_freq <- 0
for (i in rlist){
  dim_lateralreceptorAV[dim_lateralreceptorAV$`3SQ9_reslist` == i, ]$receptor_freq <- dim_lateralreceptorAV[dim_lateralreceptorAV$`3SQ9_reslist` == i, ]$receptor_freq + 1
}
...
write.csv(dim_lateralligandAV, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_lateralligandAV.csv")

write.csv(dim_lateralreceptorAV, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_lateralreceptorAV.csv")

#WT
rm(list = ls())

path <- "c:/users/wessec/documents/research/rpi gb/zdockoutput/blocked_3SQ9/Docking_3SQ9/dim_lateralWT/Analysis/20210813_175828_output.txt"
...
dim_lateralreceptorWT <- data.frame(matrix(nrow = 0, ncol = 2))
colnames(dim_lateralreceptorWT) <- c("3SQ9_reslist", "receptor_freq")
dim_lateralligandWT <- data.frame(matrix(nrow = 0, ncol = 2))
colnames(dim_lateralligandWT) <- c("2nao_reslist", "ligand_freq")
...
dim_lateralreceptorWT$receptor_freq <- 0
for (i in rlist){
  dim_lateralreceptorWT[dim_lateralreceptorWT$`3SQ9_reslist` == i, ]$receptor_freq <- dim_lateralreceptorWT[dim_lateralreceptorWT$`3SQ9_reslist` == i, ]$receptor_freq + 1
}
...
write.csv(dim_lateralligandWT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_lateralligandWT.csv")

write.csv(dim_lateralreceptorWT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_lateralreceptorWT.csv")

##dim_stacked
#A2T
rm(list = ls())

path <- "c:/users/wessec/documents/research/rpi gb/zdockoutput/blocked_3SQ9/Docking_3SQ9/dim_stackedA2T/Analysis/20210813_183655_output.txt"

temp <- read.csv(path, skip = 3, header = F, sep = "", stringsAsFactors = F) # DOUBLE CHECK HERE IF COPY PASTING: 'skip' should be 1 typically but sometimes needs some help with many invalids in top rows
temp[, 2] <- gsub("invalid", NA, temp[, 2])
temp <- na.omit(temp) #see how many invalids here
...
write.csv(dim_lateralligandAT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_stackedligandAT.csv")

write.csv(dim_lateralreceptorAT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_stackedreceptorAT.csv")

#A2V
rm(list = ls())

path <- "c:/users/wessec/documents/research/rpi gb/zdockoutput/blocked_3SQ9/Docking_3SQ9/dim_stackedA2V/Analysis/20210813_185257_output.txt"
...
write.csv(dim_lateralligandAV, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_stackedligandAV.csv")

write.csv(dim_lateralreceptorAV, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_stackedreceptorAV.csv")

#WT
rm(list = ls())

path <- "c:/users/wessec/documents/research/rpi gb/zdockoutput/blocked_3SQ9/Docking_3SQ9/dim_stackedWT/Analysis/20210813_190129_output.txt"
...
write.csv(dim_lateralligandWT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_stackedligandWT.csv")

write.csv(dim_lateralreceptorWT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/dim_stackedreceptorWT.csv")

##mono
#A2T
rm(list = ls())

path <- "c:/users/wessec/documents/research/rpi gb/zdockoutput/blocked_3SQ9/Docking_3SQ9/mono_A2T/Analysis/20210813_191406_output.txt"

temp <- read.csv(path, skip = 45, header = F, sep = "", stringsAsFactors = F) # DOUBLE CHECK HERE IF COPY PASTING: 'skip' should be 1 typically but sometimes needs some help with many invalids in top rows
temp[, 2] <- gsub("invalid", NA, temp[, 2])
temp <- na.omit(temp) #see how many invalids here
...
write.csv(dim_lateralligandAT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/mono_ligandAT.csv")

write.csv(dim_lateralreceptorAT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/mono_receptorAT.csv")

#A2V
rm(list = ls())

path <- "c:/users/wessec/documents/research/rpi gb/zdockoutput/blocked_3SQ9/Docking_3SQ9/mono_A2V/Analysis/20210813_192012_output.txt"

temp <- read.csv(path, skip = 47, header = F, sep = "", stringsAsFactors = F) # DOUBLE CHECK HERE IF COPY PASTING: 'skip' should be 1 typically but sometimes needs some help with many invalids in top rows
temp[, 2] <- gsub("invalid", NA, temp[, 2])
temp <- na.omit(temp) #see how many invalids here
...
write.csv(dim_lateralligandAV, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/mono_ligandAV.csv")

write.csv(dim_lateralreceptorAV, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/mono_receptorAV.csv")

#WT
rm(list = ls())

path <- "c:/users/wessec/documents/research/rpi gb/zdockoutput/blocked_3SQ9/Docking_3SQ9/mono_WT/Analysis/20210813_192705_output.txt"

temp <- read.csv(path, skip = 46, header = F, sep = "", stringsAsFactors = F)
temp[, 2] <- gsub("invalid", NA, temp[, 2])
temp <- na.omit(temp) #see how many invalids here
...
write.csv(dim_lateralligandWT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/mono_ligandWT.csv")

write.csv(dim_lateralreceptorWT, "c:/users/wessec/documents/research/rpi gb/data/bfactor/3SQ9_blocked/zdock/mono_receptorWT.csv")
