...
file = open("g:/research/belfortlocalfiles/data/bfactor/mono_receptorWT.csv", 'r')
...
cmd.label("top75 and n. CA", '"(%s%s%s,%s)"%(resn,resi,chain,b)')
cmd.set("label_position",(3,0,4))
